...
import io.github.cmartinezs.stl4j.task.TaskTestCommon;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

class TaskPredicateFactoryTest extends TaskTestCommon {
    @Test
    void task_isNull_false() {
        Assertions.assertFalse(TaskPredicateFactory.isNull().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))));
    }
    ...
    void task_isNonNull_true() {
        Assertions.assertTrue(TaskPredicateFactory.isNonNull().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))));
    }
    ...
    void task_isCreated_true() {
        Assertions.assertTrue(TaskPredicateFactory.isCreated().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }

    @Test
    void task_isCreated_false() {
        Task aSimpleTask = new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()));
    ...
    void task_isReady_false() {
        Assertions.assertFalse(TaskPredicateFactory.isReady().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }
    ...
    void task_isWaiting_false() {
        Assertions.assertFalse(TaskPredicateFactory.isWaiting().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }
    ...
    void task_isExecuting_false() {
        Assertions.assertFalse(TaskPredicateFactory.isExecuting().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }
    ...
    void task_isSuccess_false() {
        Assertions.assertFalse(TaskPredicateFactory.isSuccess().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }

    @Test
    void task_isFailed_true() {
        Task aSimpleTask = new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()), false);
        Assertions.assertDoesNotThrow(aSimpleTask::execute, "An exception occurred");
    ...
    void task_isFailed_false() {
        Assertions.assertFalse(TaskPredicateFactory.isFailed().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }
    ...
    void task_isEnded_false() {
        Assertions.assertFalse(TaskPredicateFactory.isEnded().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }
    ...
    void task_isStarted_false_created() {
        Assertions.assertFalse(TaskPredicateFactory.isStarted().test(new BooleanTask(createTaskName(BooleanTask.class.getSimpleName()))), "The status of the task does not correspond");
    }
